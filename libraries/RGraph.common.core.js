            ...
            if (prop['chart.background.grid']) {
                ...
                if (prop['chart.background.grid.autofit']) {
                    ...
                    */
                    ...
                    var vsize = ((ca.width - gutterLeft - gutterRight - prop['chart.hmargin'])) / prop['chart.background.grid.autofit.numvlines'];
                ...
                if (prop['chart.background.grid.vlines']) {
                    ...
                    var vsize = prop['chart.background.grid.vsize'];
                        for (x=gutterLeft + prop['chart.hmargin']; x<=width; x+=vsize) {
